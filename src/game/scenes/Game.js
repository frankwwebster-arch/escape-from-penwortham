...
export default class Game extends Phaser.Scene {
  ...
  drawFloor() {
    this.add.rectangle(400, 46, 760, 68, 0x254f6c, 0.96).setStrokeStyle(3, 0xf7f0c6)
    this.add.rectangle(400, 46, 728, 44, 0x3a7091, 0.7).setStrokeStyle(2, 0xffffff, 0.15)
    ...
    for (let y = this.roomTop; y < this.roomBottom; y += tileSize) {
      for (let x = this.roomLeft; x < this.roomRight; x += tileSize) {
        ...
        const color = useAltColor ? 0xf1e2b7 : 0xe8d49f
  ...
  createCoin(x, y) {
    ...
    const inner = this.add.circle(0, 0, 6, 0xffef99)
    const shine = this.add.rectangle(-3, -3, 6, 2, 0xffffff, 0.7).setAngle(-25)

    coin.add([glow, outer, inner, shine])
    return coin
  }
  ...
  createKey() {
    ...
    const keyGlow = this.add.circle(0, 0, 18, 0xa9f0ff, 0.28)
    ...
    this.key.add([keyGlow, keyHead, keyHole, keyStem, keyToothTop, keyToothBottom])
  ...
  createHallMonitor() {
    ...
    this.hallMonitorBody = this.add.rectangle(this.hallMonitor.x, this.hallMonitor.y + 2, 24, 24, 0xd54c4c)
  ...
  createPlayer() {
    ...
    this.playerBody = this.add.rectangle(this.player.x, this.player.y + 2, 22, 24, 0x3b82f6)
    ...
    this.playerHair = this.add.rectangle(this.player.x, this.player.y - 20, 18, 7, 0x5c3b22)
  ...
  createUi() {
    ...
    this.scoreBadge = this.add.rectangle(575, 34, 120, 34, 0xf6ecc0).setStrokeStyle(2, 0x92743b)
    ...
    this.keyBadge = this.add.rectangle(685, 34, 110, 34, 0xd8eef8).setStrokeStyle(2, 0x3e7998)
